        ...
        <>
          <Modal show={show} onHide={props.handleHide}>
            ...
            <Modal.Body>
                    ...
                    <Button className="mt-3" variant="primary" onClick={handleCrearCohorte}>Crear Cohorte</Button>
                </Modal.Body>
                    <Modal.Header>
                ...
                <Modal.Body>
                    <Form.Group controlId="formCohorte" className="mt-2">
                        ...
                        <Form.Control as="select" onChange={handleCohorte} required>
                            <option key='blank' hidden value>Seleccione uno</option>
                            {cohortes.map(cohorte =>
                                <option
                                    key={cohorte.idCohorte}
