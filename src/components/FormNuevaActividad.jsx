	  ...
	  <div> 
					<Form.Group >
					  ...
					  <Form.Control as="select" onChange={handleDependencia} >
						...
						{dependencias.map((dependencia) => {return (<option value={dependencia.idDependencia} key={dependencia.idDependencia}>{dependencia.nombre}</option>)})}
						</Form.Control>
					</Form.Group>
					<Form.Group >
					  ...
					  <Form.Control as="select" >
						<option selected disabled>Seleccione una</option>
						{propuestas.map((propuesta) => {return (<option value={propuesta.idPropuesta} key={propuesta.idPropuesta}>{propuesta.nombre}</option>)})}
						</Form.Control>
					</Form.Group>
					<Form.Group >
